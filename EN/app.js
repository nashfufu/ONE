...
let category_text = "Anonymous Support Group";
let recordedChunks = [];
let mediaRecorder;
...
async function startRecording() {
    ...
    if (recordingsCount < 10 || bubbleClicks >= 3) {
        ...
        alert("Please listen to 3 stories first, then it's your turn.");
        return;
    }
    /*
    if (bubbleClicks < 3) {
...
function playAudio(url, bubble) {
    if(isiOS())
    {
        alert("Currently, iPhones don't support listening to others' shared audio recordings of their feelings, but you can still record your own. Others will be able to listen to your shares on an Android phone or a computer browser.");
        return;
    }
    ...
    currentAudio.onerror = function(e) {
        ...
        const errorMessages = [
            "This story might be silent.",
            "Perhaps the storyteller chose silence as their expression.",
            "Silence can be powerful too.",
            "The storyteller might be choosing silence at this moment.",
            "This story is empty, perhaps the storyteller is finding their voice.",
            "Maybe this is a story without words.",
            "Some stories are felt, even without sound.",
            "This silent story might be deeper than any words can express.",
            "An empty bubble...",
            "The storyteller might have chosen this way to express their feelings."
        ];
        // 如果音频对象有错误信息，显示该信息
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    //Event snippet for 網頁瀏覽__英文語系 conversion page -->
    gtag('event', 'conversion', {'send_to': 'AW-11305151122/E4zjCNi7tNQYEJLV244q'});
